        ...
        <div className="bg-white h-full p-4 md:p-8 lg:p-8">
            <div className="max-w-3xl mx-auto text-center">
                <h2 className="text-2xl md:text-4xl lg:text-4xl font-bold mb-4 text-black">
                    Face Replicate - Replicate Face To Many & PS2 Filter AI
                </h2>
                <h3 className="text-lg text-gray-600 mb-8">
                    Makes it simple for you to replicate face, create PS2 Filter AI photos in seconds, to participate in this PS2 Filter
                    AI trend.
                </h3>
                <div
